...
import CoursesContainer, {allFiltersOnPage} from "../components/CoursesContainer/CoursesContainer";
...
const ProfessionsPage = ({professions, coursesCount}) => {
  return (
    <>
      <CustomHead
        title={'Наши курсы'}
        keywords={['курсы', 'обучение', 'образование', 'навыки', '5 шагов', 'научиться', 'бизнес', 'five steps', 'IT', 'маркетинг', 'программирование']}
...
export const getServerSideProps = wrapper.getServerSideProps(async (ctx) => {
  ...
  const filters = ctx.query.filters ? ctx.query.filters.split(',') : allFiltersOnPage
